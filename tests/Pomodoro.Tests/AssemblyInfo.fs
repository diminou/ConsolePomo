...
[<assembly: AssemblyTitleAttribute("Pomodoro.Tests")>]
[<assembly: AssemblyProductAttribute("Pomodoro")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Pomodoro.Tests"
    let [<Literal>] AssemblyProduct = "Pomodoro"
